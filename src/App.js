...
At Golden Wings, we don’t see disabilities — we see **possibilities**. Every child is a promise of hope, and we are here to help them spread their wings and soar beyond limitations.`,
  ...
  const whyContent = {
    facilities:
      "Golden Wings features state-of-the-art facilities specifically designed to support child development and learning. Our sensory-friendly classrooms are equipped with adjustable lighting, quiet areas, and carefully curated sensory tools.",
    personalized:
      "Every child at Golden Wings receives a personalized care plan developed through comprehensive assessment and collaboration with families. We begin with thorough evaluations across all developmental domains.",
    proven:
      "Golden Wings has established a proven track record of success in supporting children with diverse developmental and learning needs. Our data-driven approaches ensure that every intervention is based on systematic measurement and analysis.",
    family:
      "Family support and involvement are cornerstones of Golden Wings' philosophy. We recognize that parents and caregivers are the primary advocates and support system for their children.",
  };
  ...
  return (
    <div style={styles.appContainer}>
      ...
      <nav style={styles.navbar}>
        <div style={styles.navbarContent}>
          ...
          <div style={styles.navLinks}>
            ...
            <a href="#therapies" style={styles.navLink}>
              Therapies
            </a>
        ...
        {mobileMenuOpen && (
          <div style={styles.mobileMenu}>
            <a href="#services" style={styles.mobileMenuLink}>
              Services
            </a>
            <a href="#therapies" style={styles.mobileMenuLink}>
              Therapies
            </a>
            <a href="#why" style={styles.mobileMenuLink}>
              Why Us
            </a>
            <a href="#contact" style={styles.mobileMenuLink}>
              Contact
            </a>
          </div>
        )}
            ...
            <div className="gw-hero-content">
              <div style={styles.marqueeBanner}>
                <p style={styles.marqueeText}>
                  Golden Wings Child Development Center and Inclusive Special
                  School
                </p>
              </div>
              ...
              <div style={styles.teluguText}>
                గోల్డెన్ వింగ్స్ బాల అభివృద్ధి కేంద్రం మరియు సమగ్ర ప్రత్యేక
                పాఠశాల
              </div>
      ...
      <section id="therapies" style={styles.therapiesSection}>
        <div style={styles.sectionContainer}>
          <h2 style={styles.sectionTitle}>
            Therapeutic Services (చికిత్సా సేవలు)
          </h2>
          <div style={styles.therapiesGrid}>
            {therapies.map((therapy, idx) => (
              ...
              >
                ...
                <button
                  style={styles.toggleBtn(
                    styles.therapyToggleBtn.backgroundColor
                  )}
                  onClick={() =>
          ...
          <div style={styles.whyGrid}>
            {whyItems.map((item, idx) => (
              ...
              >
                ...
                {expandedWhy === idx && (
                  <div style={styles.whyContent}>{whyContent[item.id]}</div>
                )}
              </div>
            ))}
          </div>
      ...
      <section id="contact" style={styles.contactSection}>
        <div style={styles.sectionContainer}>
          <h2 style={{ ...styles.sectionTitle, ...styles.contactTitle }}>
            Get In Touch
          </h2>
          <div style={styles.contactGrid}>
            ...
            <button
              ...
              onClick={() =>
                window.open(
                  "https://maps.google.com/?q=4-7-84/2+opp+Vinayak+Nagar+Hyderabad",
                  "_blank"
                )
              }
              onMouseOver={(e) =>
      ...
      <footer style={styles.footer}>
        ...
        <div style={styles.founderSection}>
          <div style={styles.founderCard}>
            <img src="\founder.jpg" alt="." style={styles.founderImage} />
            <p style={styles.founderName}>Mr. G.Mallikarjun (Founder)</p>
          </div>

          <div style={styles.founderCard}>
            <img src="\cofounder.jpg" alt="." style={styles.founderImage} />
